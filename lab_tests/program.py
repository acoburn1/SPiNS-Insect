...
DATA_PARAMS = { "losses": False,
                ...
                "output_activation_tests": False,
                "hidden_activation_tests": True }
...
for i in range(1, 101):
    ...
    np.savez(f"Results/Data/Focused_04/by_sets/p_m{i}.npz", **results)
    print(i)
"""

for e in range(0, 61):
    StatOutput.plot_scatter_models(f"Results/Data/Focused_04/by_sets", e, include_e0=INCLUDE_E0)
